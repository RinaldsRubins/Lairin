...
@section('page_title', 'Jauns raksts')
...
<form method="POST" action="{{ route('admin.blog-posts.store') }}" class="max-w-3xl">
    @csrf
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-6">
        ...
        <div>
            ...
            <textarea id="excerpt" name="excerpt" rows="3"
                      class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none">{{ old('excerpt') }}</textarea>
        ...
        <div>
            ...
            <textarea id="content" name="content" rows="12" required
                      class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm font-mono focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none">{{ old('content') }}</textarea>
    ...
    <div class="mt-6 flex items-center gap-3">
        ...
        <a href="{{ route('admin.blog-posts.index') }}" class="text-sm text-secondary-500 hover:text-secondary-700">Atcelt</a>
    </div>
</form>
@endsection
