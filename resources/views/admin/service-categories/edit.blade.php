...
@section('page_title', 'Rediģēt kategoriju')
...
<form method="POST" action="{{ route('admin.service-categories.update', $category) }}" class="max-w-3xl">
    @csrf
    @method('PUT')
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-6">
        ...
        <div>
            ...
            <textarea id="description" name="description" rows="4"
                      class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none">{{ old('description', $category->description) }}</textarea>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="meta_description" name="meta_description" rows="2"
                              class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none">{{ old('meta_description', $category->meta_description) }}</textarea>
    ...
    <div class="mt-6 flex items-center gap-3">
        ...
        <a href="{{ route('admin.service-categories.show', $category) }}" class="text-sm text-secondary-500 hover:text-secondary-700">Skatīt</a>
    </div>
</form>
@endsection
