...
@section('page_title', 'Jauns projekts')
...
<form method="POST" action="{{ route('admin.projects.store') }}" class="max-w-3xl">
    ...
    <div class="mt-6 flex items-center gap-3">
        ...
        <a href="{{ route('admin.projects.index') }}" class="text-sm text-secondary-500 hover:text-secondary-700">Atcelt</a>
    </div>
</form>
@endsection
